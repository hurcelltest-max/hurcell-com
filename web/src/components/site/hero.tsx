      ...
      >
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-400 text-xs font-mono mb-8 backdrop-blur-xl">
            <Zap size={14} className="animate-pulse" /> SYSTEM STATUS: OPTIMIZED
          </div>
          ...
          <p className="text-lg md:text-2xl text-blue-100/60 max-w-3xl mx-auto mb-12 font-light tracking-wide">
            Where luxury meets the bleeding edge of cybernetic hardware. 
            Engineered for the next generation of digital pioneers.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Button size="lg" className="h-16 px-10 rounded-none bg-blue-600 hover:bg-blue-500 text-white font-bold tracking-widest uppercase transition-all neon-glow border-none">
              ENTER SYSTEM
        ...
        >
          <div className="flex items-center justify-center gap-2 font-mono text-[10px] tracking-[0.2em]">
            <Cpu size={14} /> NEURAL PROCESSING
          </div>
          <div className="flex items-center justify-center gap-2 font-mono text-[10px] tracking-[0.2em]">
            <ShieldCheck size={14} /> BIOMETRIC SECURE
          </div>
